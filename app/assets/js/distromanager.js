...
const DEV_PATH = 'D:/Work/Minecraft/Launchers/pokeresort/app/assets/distribution.json'
...
exports.pullRemote = function(){
    ...
    return new Promise((resolve, reject) => {
        const distroURL = 'https://pokeresort.b-cdn.net/pokelauncher/distribution.json'
        const opts = {
            url: distroURL,
            timeout: 2500
        }
